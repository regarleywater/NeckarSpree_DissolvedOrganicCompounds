...
# How to run code
1. Download and unzip folder with the included data subfolder
2. Open .R file in RStudio
3. Personalize Directory address
4. Run entire code - additional subfolders as well as .csv and .pdf files will be generated
